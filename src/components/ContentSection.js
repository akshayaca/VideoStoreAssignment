            ...
            <div className="mt-12 text-center mx-auto px-6 md:px-4 lg:px-10" style={{ background: 'linear-gradient(to right, #191970, #000000)', maxWidth: 'full' }}> 
                ...
                <div className="flex flex-col items-center justify-center lg:gap-8"> 
                    ...
                    <button 
                        ...
                        className={`bg-black text-white font-bold py-2 px-4 my-4 ${!isAuthenticated ? 'opacity-50 cursor-not-allowed' : ''}`}
                        style={{ transition: 'background-color 300ms ease-in-out' }}
                        onMouseEnter={e => e.currentTarget.style.backgroundColor = "#191970"}
